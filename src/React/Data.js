...
export let store = {
        ...
        postsPage:
            {postsData:[
                    {heading:'Time management',
                        ...
                        postContent:'sdfsdfdsfdsf dfsdfsdfsdd dsfsdfsdfsddf dsf sdfsdf sdf ddfdsfsdfd sdfsdfsdfds dsfsdfsdf sdfsdfsdf ssdfsdfdsdf dsfdfsdf sdfsdfsdf dsfsdfsddf' },
                    {heading:'Programming',
    ...
    newMassage (id) {
        let newMessage = { id:10, abonent: 'in', text: this._data.messagesPage[id-1].textareaMassage}
        this._data.messagesPage[id-1].messagesData.push(newMessage)
        this._goRender(this._data)
        this._data.messagesPage[id-1].textareaMassage = ''
    },
    textareaChanges(text, id) {
        this._data.messagesPage[id-1].textareaMassage = text
        this._goRender(this._data)
    }*/
}